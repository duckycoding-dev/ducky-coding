...
How have I done this? Using powerful tools built into <abbr title='Hyper text markup language'>HTML</abbr>.\
<abbr title='Hyper text markup language 5'>HTML5</abbr>'s `<img />`'s `srcset` and `sizes` attributes come into play for managing this without the need of writing any JavaScript.
