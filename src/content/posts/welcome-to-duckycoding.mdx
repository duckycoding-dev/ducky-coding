...
- **Framework agnostic**: I could use React, Vue, or any other framework if needed, but most of the site is pure <abbr title='Hyper text markup language'>HTML</abbr>/<abbr title='Cascading style sheets'>CSS</abbr> written in Astro components
...
### 🗄️ SQLite + Drizzle <abbr title='Object Relational Mapper'>ORM</abbr> - Simple yet powerful data layer
...
**Why Drizzle <abbr title='Object Relational Mapper'>ORM</abbr>?**
...
- **[TailwindCSS v4](https://tailwindcss.com/blog/tailwindcss-v4)**: Utility-first <abbr title='Cascading style sheets'>CSS</abbr> framework for rapid development
- **Mobile-First Approach**: Every component is designed mobile-first, then enhanced for larger screens
- **Custom Color System**: Carefully crafted color palette (= whatever colors I liked 👀) with <abbr title='Cascading style sheets'>CSS</abbr> custom properties
...
Every page is optimized for <abbr title='Search Engine Optimization'>SEO</abbr> with: 
- **Meta tags**
- **Open Graph and Twitter Cards**: Custom images and metadata for social sharing
- **Structured Data**: <abbr title='JavaScript Object Notation for Linked Data'>JSON-LD</abbr> for rich search results
...
- **<abbr title='Cascading style sheets'>CSS</abbr> Purging**: Unused <abbr title='Cascading style sheets'>CSS</abbr> is automatically removed in production
- **Minimal JavaScript**: Most components ship as static <abbr title='Hyper text markup language'>HTML</abbr>, with JavaScript only for interactivity when needed (e.g. the sidemenu on small screens uses some JavaScript to toggle the menu visibility by swiping left or right)
...
- **Quick guides**: Short, focused tutorials on specific topics like Astro features, <abbr title='Cascading style sheets'>CSS</abbr> tricks, TypeScript tips, web performance optimization, etc,...
