---
title: 'How I avoided self-referencing links in my website and why I think you should too'
summary: "Learn how to prevent self-referencing links in your website's navigation structure, enhancing user experience, accessibility and SEO."
...
## Let's understand what self-referencing links are and why I've decided to avoid them

Self-referencing links in a website can create a confusing user experience.\
...
<div class="my-2 overflow-x-scroll">
  <Image src={desktopNavbar} alt="Example of my desktop navigation menu with self-referencing links removed" class='h-[70px] w-auto max-w-none'/>
</div>
